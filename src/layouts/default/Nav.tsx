        ...
        <nav tw="flex items-center flex-wrap p-3 ">
          <Link href="/">
            <a tw="inline-flex items-center p-2 mr-4">
              <span tw="text-xl text-gray-50 font-bold uppercase tracking-wide">
                HK Classes
              </span>
            </a>
          </Link>
          ...
          <div tw="w-full lg:inline-flex lg:flex-grow lg:w-auto">
            <div tw="lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full lg:items-center items-start  flex flex-col lg:h-auto">
              <Link href="/">
                <a tw="lg:inline-flex lg:w-auto w-full px-3 py-2 rounded text-gray-50 items-center justify-center hover:text-primary hover:bg-white cursor-pointer">
                  Home
                </a>
              </Link>
