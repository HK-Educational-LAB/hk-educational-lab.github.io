...
const FooterSection: NextPage<Props> = () => {
  return (
    <footer tw="bg-white pt-20 lg:pt-[120px] pb-10 lg:pb-20 relative z-10">
      <div tw="container mx-auto">
        <div tw="flex justify-center text-center">
          <div tw="w-full sm:w-2/3 lg:w-3/12 px-4">
            <div tw="w-full mb-10">
              <h4 tw="text-lg font-semibold mb-9">Follow Us On</h4>
              ...
              <p tw="flex justify-center items-center text-sm font-medium">
                ...
                <span>09 523 16 39 / 09 970 720 203</span>
              </p>

              <div tw="flex justify-center items-center mb-6">
                <a
                  ...
                  tw="
                         ...
                         hover:text-white hover:bg-gray-50
                         mr-3
                         sm:mr-4
                         lg:mr-3
                         xl:mr-4
