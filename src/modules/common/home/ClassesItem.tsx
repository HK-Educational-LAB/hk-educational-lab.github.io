...
const SHomeClassesItemContainer = styled.div`
  ${tw`w-full md:w-1/2 lg:w-1/3 px-4`}
`;

const SHomeClassesItem = styled.div`
  ${tw`
        p-10
        md:px-7
        xl:px-10
...
const SHomeClassesItemSvgContainer = styled.div`
  ${tw`
        w-[70px]
        h-[70px]
        flex
...
const HomeClassesItem: NextPage<Props> = ({
  title,
  summary = `lorem Ipsum is simply dummy text of the printing and typesettig
industr Ipsum has been the industry`,
}) => {
  return (
    <SHomeClassesItemContainer>
      <SHomeClassesItem>
        <SHomeClassesItemSvgContainer>
          <svg
            width="32"
            height="32"
            viewBox="0 0 32 32"
        ...
        <Title tw="text-lg font-bold mb-3" size="h4">
          {title}
        </Title>
        <Text tw="text-base">{summary}</Text>
      </SHomeClassesItem>
    </SHomeClassesItemContainer>
  );
};

export default HomeClassesItem;
